            ...
            <div class="box box-warning">
                <div class="box-header" style="margin-top: 20px;margin-left: 10px">
                    <p>
                        ...
                        <a href="{{url('kas_mesjid_masuk')}}" class="btn btn-primary"><i class="fa fa-backward"></i> Kembali</a>
                    </p>
                    @if ($errors->any())
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form"method="post" action="{{ url('kas_mesjid_masuk', $dt->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="masuk" placeholder="Jumlah Pemasukan" value="{{ $dt->masuk }}">
                                </div>
                                <div class="form-group">
