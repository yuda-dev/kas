            ...
            <div class="box box-warning">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form"method="post" action="{{ url('kas_sosial_keluar', $dt->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Uraian</label>
                                    <input type="text" class="form-control" name="uraian" placeholder="Uraian Pengeluaran" value="{{ $dt->uraian }}">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Pengeluaran</label>
                                    <input type="text" class="form-control" name="keluar" placeholder="Jumlah Pengeluaran" value="{{ $dt->keluar }}">
                                </div>
                                <div class="form-group">
